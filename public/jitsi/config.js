...
var config = {
    ...
    hosts: {
        // XMPP domain - configured for localhost
        domain: 'localhost',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.localhost',
    ...
    // BOSH URL - disabled for standalone mode
    // bosh: 'https://localhost/' + subdir + 'http-bind',

    // Websocket URL - disabled for standalone mode
    // websocket: 'wss://localhost/' + subdir + 'xmpp-websocket',
    ...
    // Configs for welcome page - DISABLED for MindWave
    welcomePage: {
        // Disable welcome page - join meetings directly
        disabled: true,
        // If set, landing page will redirect to this URL.
        customUrl: ''
    },

    // Configs for the lobby screen - DISABLED for MindWave
    lobby: {
        // Disable lobby completely - everyone joins directly
        autoKnock: false,
        // Disable lobby chat
        enableChat: false,
    },

    // Configs for the security related UI elements - customized for MindWave
    securityUi: {
        // Hide lobby button completely
